...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'default        nil :family "FiraCode Nerd Font"            :height fixed-size    :weight 'medium)
  (set-face-attribute 'fixed-pitch    nil :family "FiraCode Nerd Font"            :height fixed-size    :weight 'medium)
  (set-face-attribute 'variable-pitch nil :family "FiraCode Nerd Font Mono" :height variable-size :weight 'normal)
#+end_src
